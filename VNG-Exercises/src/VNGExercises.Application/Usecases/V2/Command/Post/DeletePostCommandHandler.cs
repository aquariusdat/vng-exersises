...
{
    public class DeletePostCommandHandler : ICommandHandler<Contract.Services.V2.Post.Command.DeletePostCommand, bool>
    {
        ...
        public async Task<Result<bool>> Handle(Contract.Services.V2.Post.Command.DeletePostCommand request, CancellationToken cancellationToken)
        {
