...
{
    public class GetPostQueryHandler : IQueryHandler<Contract.Services.V1.Post.Query.GetPostQuery, PagedResult<Response.PostResponse>>
    {
        ...
        public async Task<Result<PagedResult<Response.PostResponse>>> Handle(Contract.Services.V1.Post.Query.GetPostQuery request, CancellationToken cancellationToken)
        {
