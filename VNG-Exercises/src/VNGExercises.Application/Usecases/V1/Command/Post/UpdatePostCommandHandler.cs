...
{
    public class UpdatePostCommandHandler : ICommandHandler<Contract.Services.V1.Post.Command.UpdatePostCommand, Contract.Services.V1.Post.Response.PostResponse>
    {
        ...
        public async Task<Result<Response.PostResponse>> Handle(Contract.Services.V1.Post.Command.UpdatePostCommand request, CancellationToken cancellationToken)
        {
